...
<div class="main-header">
    ...
    <p>Tác giả: Sằm Thị Huyền - Trường TH Vĩnh Thành - ĐT: 0855193499</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Sằm Thị Huyền - Trường TH Vĩnh Thành - ĐT: 0855193499</div>", unsafe_allow_html=True)
